...
def product(request,product):  
  if request.method=='GET':
    driver = wb.Chrome('D:/chromedriver_win32/chromedriver')
    Pname=product
  ...
  # flipkart
    ...
    obj=dummy(id=1,des=des,imag_url=imag_url,linkA=linkA,linkF=linkF,amazonP=amazonP,flipkartP=flipkartP)
    obj.save()
    ...
    if request.user.is_authenticated==False:
      ...
      data={'p': Pname,'a': obj.linkA, 'f': obj.linkF, 'pA': obj.amazonP,'pF': obj.flipkartP}
